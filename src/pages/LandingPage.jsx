  ...
  return (
    <div className="absolute inset-0 overflow-hidden pointer-events-none">
      ...
      <div
        ...
        style={{
          backgroundImage: `linear-gradient(rgba(0,119,200,0.08) 1px, transparent 1px), linear-gradient(90deg, rgba(0,119,200,0.08) 1px, transparent 1px)`,
      ...
      {[...Array(12)].map((_, i) => (
        <motion.div
          ...
          style={{
            ...
            top: `${Math.random() * 100}%`,
            background: `rgba(0, ${100 + Math.random() * 100}, 200, ${0.3 + Math.random() * 0.4})`,
          }}
          animate={{
    ...
    >
      ...
      >
          ...
          <div>
            <div className="flex items-center gap-3 mb-2">
              ...
              <div>
                ...
                <p className="text-white/40 text-xs">Generated by KPMG AI · K-Nexus Intelligence Platform</p>
              </div>
            </div>
          </div>
        ...
        <div className="mt-6 pt-6 border-t border-white/10 flex items-center justify-between">
          <p className="text-white/30 text-xs">Powered by Claude claude-sonnet-4-20250514 · K-Nexus.AI</p>
          <button
            onClick={onClose}
      ...
      <AnimatePresence>
        {(phase === 'logo' || phase === 'shrink') && (
          ...
          >
            ...
            >
              <div className="text-7xl font-extrabold text-white tracking-widest mb-3" style={{ fontFamily: "'Plus Jakarta Sans', sans-serif" }}>
                KPMG
              </div>
              <div className="text-white/50 text-sm tracking-[6px] uppercase">Datacenter Intelligence</div>
            </motion.div>
          </motion.div>
        )}
      </AnimatePresence>
        ...
        <div className="max-w-screen-xl mx-auto">
          ...
          >
            ...
            >
              ...
              <br />
              <span className="text-transparent bg-clip-text" style={{ backgroundImage: 'linear-gradient(90deg, #0077C8, #4FC3F7)' }}>
          ...
          <div className="flex flex-col items-center justify-center gap-8">
            ...
            >
              <button
                ...
                className="inline-flex items-center justify-center gap-2 px-6 py-3 bg-white text-[#00338D] font-bold rounded-xl hover:bg-[#F4F6F9] transition-colors text-sm shadow-lg"
                style={{ fontFamily: "'Plus Jakarta Sans', sans-serif" }}
              >
                <Globe size={16} />
              ...
              <p className="text-white/30 text-xs text-center mt-2">35 facilities · 5 countries · Live intelligence</p>
            </motion.div>
          </div>
          ...
          >
            <h2 className="text-white/60 text-center text-sm font-semibold uppercase tracking-widest mb-8">
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-3">
              {[
                ...
                <motion.button
                  ...
                  className="glass rounded-xl p-4 text-center hover:bg-white/12 transition-all group hover:-translate-y-1 border border-white/5 hover:border-[#0077C8]/30"
                  initial={{ y: 20, opacity: 0 }}
                  animate={{ y: 0, opacity: 1 }}
                  transition={{ delay: 0.9 + i * 0.06 }}
                >
                  <div className="text-[#0077C8] font-mono font-bold text-xs mb-2 opacity-70">{s.num}</div>
                  <div className="text-white font-semibold text-xs leading-tight whitespace-pre-line" style={{ fontFamily: "'Plus Jakarta Sans', sans-serif" }}>
                    {s.label}
                  </div>
                </motion.button>
              ))}
